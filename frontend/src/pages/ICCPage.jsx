          ...
          {result?.coordination && (
            <div
              className={`mt-4 p-3 rounded ${
                result.coordination.coordinated
            ...
            <div>
              ...
              <div
                className={`font-semibold ${
                  result.status === 'ok' ? 'text-green-600' : 'text-yellow-600'
                }`}
              >
                {result.status}
              </div>
  ...
  return (
    <svg width="100%" height="300" className="border rounded bg-gray-50">
        ...
        return (
          <g key={breaker.id}>
            <rect
              ...
              rx="2"
            />
            <text x={x} y={140} textAnchor="middle" fontSize="9" fill="#92400e">
              {breaker.model}
            </text>
          </g>
        )
      ...
      <g transform="translate(20, 280)">
        ...
        <text x="140" y="4" fontSize="10" fill="#374151">
          Punto de falla
        </text>

        <rect x="220" y="-8" width="16" height="16" fill="#f59e0b" rx="2" />
        <text x="245" y="4" fontSize="10" fill="#374151">
          Breaker
        </text>
      </g>

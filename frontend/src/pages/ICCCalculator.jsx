...
export default function ICCCalculator() {
  ...
  const zonasElectricas = [
    {
      value: 'CDMX',
      label: 'Ciudad de México - Zona Metropolitana (23 kV)',
      isc: 28,
      xr: 12,
    },
    {
      value: 'MONTERREY',
      label: 'Monterrey - Nuevo León (23 kV)',
      isc: 25,
      xr: 12,
    },
    {
      value: 'GUADALAJARA',
      label: 'Guadalajara - Jalisco (23 kV)',
      isc: 22,
      xr: 15,
    },
    ...
    {
      value: 'TIJUANA',
      label: 'Tijuana - Baja California (23 kV)',
      isc: 16,
      xr: 18,
    },
    ...
    {
      value: 'QUERETARO',
      label: 'Querétaro - Corregidora (23 kV)',
      isc: 19,
      xr: 15,
    },
    {
      value: 'TOLUCA',
      label: 'Toluca - Estado de México (23 kV)',
      isc: 21,
      xr: 15,
    },
    ...
    {
      value: 'HERMOSILLO',
      label: 'Hermosillo - Sonora (23 kV)',
      isc: 12,
      xr: 20,
    },
    {
      value: 'VILLAHERMOSA',
      label: 'Villahermosa - Tabasco (23 kV)',
      isc: 11,
      xr: 20,
    },
    {
      value: 'PVALLARTA',
      label: 'Puerto Vallarta - Jalisco (13.2 kV)',
      isc: 16,
      xr: 18,
    },
  ...
  const capacidadesTrafo = [
    ...
    3000, 3750, 5000, 7500, 10000, 15000, 20000, 25000, 30000, 37500, 50000,
    75000, 100000,
  ]
  ...
  const handleResults = useCallback(data => {
    ...
    const hasFault =
      Array.isArray(data) &&
      data.some(punto => punto?.I3F > 0 || punto?.IfTierra > 0)
    ...
    input.onchange = event => {
      ...
      reader.onload = e => {
        try {
          ...
          handleError(
            'Error al cargar el archivo. Verifique que sea un archivo JSON válido.',
            error
          )
        } finally {
          setIsFileOperation(false)
                ...
                <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={e =>
                          setEquipmentConfig({
                            ...equipmentConfig,
                            trafoKva: Number(e.target.value),
                          })
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      >
                  ...
                  {equipmentConfig.zonaElectrica && (
                    <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                      ...
                      {(() => {
                        const zona = zonasElectricas.find(
                          z => z.value === equipmentConfig.zonaElectrica
                        )
                        return zona ? (
                          <div className="text-sm text-blue-800">
                            <p>
                              <strong>Isc en MT:</strong> {zona.isc} kA
                            </p>
                            <p>
                              <strong>X/R:</strong> {zona.xr}
                            </p>
                            <p className="text-xs mt-1">
                              Valores típicos de cortocircuito en media tensión.
                              Confirmar con CFE para diseño definitivo.
                            </p>
                          </div>
                        ) : null
                      })()}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setEquipmentConfig({
                            ...equipmentConfig,
                            iscConocido: Number(e.target.value),
                          })
                        }
                        min="0.1"
                        step="0.1"

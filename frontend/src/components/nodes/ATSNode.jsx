...
export default function ATSNode({ data, selected }) {
  ...
  return (
    <div className={`bg-white border-2 rounded-lg p-3 min-w-[150px] shadow-md ${getModeColor(mode)} ${selected ? 'ring-2 ring-blue-500' : ''}`}>
      ...
      <div className="flex items-center gap-2">
        <svg width="40" height="40" viewBox="0 0 40 40">
          ...
          {/* Switch positions */}
          <line x1="10" y1="9" x2="15" y2="9" stroke={mode === 'normal' ? '#10b981' : '#6b7280'} strokeWidth="2" />
          <line x1="25" y1="9" x2="30" y2="9" stroke="#6b7280" strokeWidth="2" />
          
          <line x1="10" y1="31" x2="15" y2="31" stroke="#6b7280" strokeWidth="2" />
          <line x1="25" y1="31" x2="30" y2="31" stroke={mode === 'emergency' ? '#f97316' : '#6b7280'} strokeWidth="2" />
          
          {/* Common output */}
          <line x1="20" y1="13" x2="20" y2="27" stroke="#374151" strokeWidth="3" />
        </svg>

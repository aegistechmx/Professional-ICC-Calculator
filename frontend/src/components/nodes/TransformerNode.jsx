    ...
    <div className="bg-white border-2 border-blue-500 rounded-lg p-3 min-w-[150px] shadow-md">
      ...
      <div className="flex items-center gap-2">
        <svg width="40" height="40" viewBox="0 0 40 40">
          {/* Primary winding */}
          <circle cx="20" cy="12" r="8" fill="none" stroke={iccColor} strokeWidth="2" />
          {/* Secondary winding */}
          <circle cx="20" cy="28" r="8" fill="none" stroke={iccColor} strokeWidth="2" />
          {/* Connection lines */}
          <line x1="20" y1="4" x2="20" y2="4" stroke={iccColor} strokeWidth="2" />
          <line x1="20" y1="36" x2="20" y2="36" stroke={iccColor} strokeWidth="2" />
        </svg>
        <div>

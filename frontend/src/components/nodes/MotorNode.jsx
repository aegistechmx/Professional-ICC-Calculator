    ...
    <div className="bg-white border-2 border-purple-500 rounded-lg p-3 min-w-[150px] shadow-md">
      ...
      <div className="flex items-center gap-2">
        <svg width="40" height="40" viewBox="0 0 40 40">
          {/* Motor circle */}
          <circle cx="20" cy="20" r="12" fill="none" stroke={iccColor} strokeWidth="2" />
          {/* Motor symbol (M) */}
          <text x="20" y="25" textAnchor="middle" fontSize="14" fontWeight="bold" fill={iccColor}>M</text>
          {/* Connection line */}
          <line x1="20" y1="4" x2="20" y2="8" stroke={iccColor} strokeWidth="2" />
          {/* Rotation indicator (arrow) */}
          <path d="M 28 12 A 8 8 0 0 1 28 28" fill="none" stroke={iccColor} strokeWidth="1.5" markerEnd="url(#arrowhead)" />
          <defs>

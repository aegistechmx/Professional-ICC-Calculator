...
export default function BreakerNode({ data }) {
  ...
  return (
    <div
      className={`bg-white border-2 rounded-lg p-3 min-w-[150px] shadow-md ${getStatusColor(breakerStatus)}`}
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="text-xs text-gray-500">
            {data.parameters?.In || 100}A /{' '}
            {(data.parameters?.Icu || 25000) / 1000}kA
          </div>
          {icc && (

...
export const CoordinationPanel = ({ width = 800, height = 600 }) => {
            ...
            {coordinationResults.results.map((result, index) => (
              <div 
                ...
                className={`p-2 rounded border ${
                  result.breaker.tripped ? 'bg-red-50 border-red-200' :
              ...
              >
                <div className="flex items-center justify-between">
                  <span className={`text-sm font-medium ${
                    result.breaker.tripped ? 'text-red-700' :
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            ...
            <div>
              ...
              <span className={`ml-2 font-medium ${
                selectedBreaker.breaker.tripped ? 'text-red-600' :

...
import { BreakerLibrary, CommonConfigurations, validateCompatibility } from '../utils/breakerLibrary.js';
      ...
      <div className="bg-white rounded-lg shadow-md p-4 border border-gray-200">
        ...
        <div className="relative" style={{ width: '100%', height: '400px' }}>
          <svg width="100%" height="100%" viewBox="0 0 800 400">
            ...
            {/* Marcas de corriente */}
            {[100, 200, 500, 1000, 2000, 5000, 10000].map((current, index) => {
            ...
            {/* Marcas de tiempo */}
            {[0.01, 0.1, 1, 10, 100].map((time, index) => {
            ...
            {faultSimulation && (
              <g>
                ...
                {/* Puntos de disparo */}
                {faultSimulation.evaluation.map((evalResult, index) => {
          ...
          <div className="p-3 bg-gray-50 rounded">
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className={`font-medium ${
                  faultSimulation.selectivity === 'achieved' ? 'text-green-600' : 'text-yellow-600'
                }`}>
          ...
          <div className="p-3 bg-gray-50 rounded">
            <div className="space-y-1 text-xs">
              <div className="flex justify-between">
                ...
                <span className={`font-medium ${
                  coordinationResults.overallCoordinated ? 'text-green-600' : 'text-red-600'
                }`}>

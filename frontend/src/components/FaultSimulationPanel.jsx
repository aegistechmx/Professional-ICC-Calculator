...
export default function FaultSimulationPanel({
  ...
  const nodosDisponibles =
    nodes?.filter(
      n => n.type === 'load' || n.type === 'motor' || n.type === 'breaker'
    ) || []
  ...
  const iniciarAnimacion = useCallback(
    ...
    [simulando, pausado, onApplyState, onSimulationEnd]
  )
  ...
  const iniciarSimulacion = useCallback(async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        iniciarAnimacion(data.data.timeline, data.data)
      } else {
  ...
  }, [configuracion, nodes, edges, onSimulationStart, iniciarAnimacion])
  ...
  return (
    <div className="fault-simulation-panel">
      <div className="panel-header">
        ...
        {simulando && (
          <button className="btn-close" onClick={detenerSimulacion}>
            ✕
          </button>
        )}
      </div>
      ...
      <div className="config-section">
        ...
        <div className="form-group">
          ...
          <select
            ...
            onChange={e =>
              setConfiguracion({ ...configuracion, tipo: e.target.value })
            }
            disabled={simulando}
          >
        ...
        <div className="form-group">
          ...
          <select
            ...
            onChange={e =>
              setConfiguracion({ ...configuracion, nodo: e.target.value })
            }
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={e =>
                setConfiguracion({
                  ...configuracion,
                  duracion: parseFloat(e.target.value),
                })
              }
              disabled={simulando}
            />
        ...
        <div className="simulation-controls">
          {!simulando ? (
            ...
            <div className="playback-controls">
              <button className="btn-control" onClick={togglePausa}>
                {pausado ? '▶' : '⏸'}
              </button>
              <button className="btn-control stop" onClick={detenerSimulacion}>
                ⏹
              </button>
            </div>
          )}
        ...
        <div className="results-section">
          ...
          <div className="summary-stats">
            ...
            <div className="stat">
              ...
              <value>
                {resultado.resumen.tiempoPrimeraOperacion?.toFixed(3) || '-'}s
              </value>
            </div>
            <div className="stat">
            ...
            <div
              className={`stat ${resultado.resumen.coordenacionExitosa ? 'success' : 'error'}`}
            >
              <label>Coordinación</label>
              <value>
                {resultado.resumen.coordenacionExitosa
                  ? '✓ Exitosa'
                  : '✗ Fallida'}
              </value>
            </div>

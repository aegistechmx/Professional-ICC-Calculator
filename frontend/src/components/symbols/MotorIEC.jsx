...
export default function MotorIEC({ size = 50 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 50 50">
      ...
      {/* Motor label 'M' */}
      <text x="25" y="30" fontSize="14" fontWeight="bold" textAnchor="middle" fill="black">M</text>
      {/* Rotation indicator arrow */}
      <path d="M 40 15 A 15 15 0 0 1 40 35" stroke="black" strokeWidth="1.5" fill="none" markerEnd="url(#arrowhead)" />
      <defs>

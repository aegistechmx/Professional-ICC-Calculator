...
export default function ProjectSetupModal({ onStart, onClose }) {
  ...
  const validateForm = () => {
    ...
    if (config.tempAmbiente < -40 || config.tempAmbiente > 60) {
      newErrors.tempAmbiente =
        'Temperatura ambiente fuera de rango (-40°C a 60°C)'
    }
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              <div className="form-group">
                ...
                />
                {errors.proyecto && (
                  <span className="error-message">{errors.proyecto}</span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                >
                  <option value="NOM-001-SEDE-2012">
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              <div className="form-group">
                ...
                {errors.voltajeBase && (
                  <span className="error-message">{errors.voltajeBase}</span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                {errors.capacidadTR && (
                  <span className="error-message">{errors.capacidadTR}</span>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                />
                {errors.tempAmbiente && (
                  <span className="error-message">{errors.tempAmbiente}</span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={e =>
                    handleChange('tempAislamiento', +e.target.value)
                  }
                >

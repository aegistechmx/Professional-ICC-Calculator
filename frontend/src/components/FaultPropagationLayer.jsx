...
export const FaultPropagationLayer = ({ width = 1200, height = 800 }) => {
  ...
  }, [nodes, edges, results, width, height, simulation])
  ...
  const handleFaultTrigger = useCallback(
    ...
    [nodes, triggerFault, tripBreaker, isUpstreamBreaker]
  )
          ...
          <div className="bg-gray-50 rounded p-3">
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {simulation.breakerTrips.length}
                </span>
              </div>
            </div>
          </div>
...
FaultPropagationLayer.propTypes = {

...
export const AutoLayoutPanel = () => {
  ...
  const { nodes, edges, setGraph, ui, toggleAutoLayout } = useGraphStore()
  ...
  const applyGridLayout = useCallback(() => {
    ...
    const maxNodesPerLevel = Math.max(
      ...Object.values(topology.levels).map(level => level.length)
    )
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              value={spacing.x}
              onChange={e =>
                setSpacing(prev => ({ ...prev, x: parseInt(e.target.value) }))
              }
              className="w-full"
            />
          </div>
          <div>
            ...
            <input
              ...
              value={spacing.y}
              onChange={e =>
                setSpacing(prev => ({ ...prev, y: parseInt(e.target.value) }))
              }
              className="w-full"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="ml-2 font-medium">
                {layoutStats.width
                  ? `${layoutStats.width}x${layoutStats.height}`
                  : 'N/A'}
              </span>
            </div>
          </div>
      ...
      <div className="mb-4 p-3 bg-gray-50 rounded">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <span className="ml-2 font-medium">
              {nodes.filter(n => n.type === 'transformer').length}
            </span>
          </div>
          <div>
          ...
          <div>
            ...
            <span className="ml-2 font-medium">
              {nodes.filter(n => n.type === 'breaker').length}
            </span>
          </div>
          <div>
            <span className="text-gray-500">Cargas:</span>
            <span className="ml-2 font-medium">
              {nodes.filter(n => n.type === 'load').length}
            </span>
          </div>
          <div>

...
var MotorAmpacidadNOM = (function () {
    ...
    function calcularAmpacidadNOM(input) {
        ...
        var nConductores = input.nConductores || 3;
        var paralelos = input.paralelos || 1;
        var tempTerminal = input.tempTerminal || 75;
        ...
        var F_temp = getFactorTemperatura(tempAmbiente, tempAislamiento);
        ...
        var F_agrup = getFactorAgrupamiento(nConductores);
...
if (typeof module !== 'undefined') {
    module.exports = MotorAmpacidadNOM;
}

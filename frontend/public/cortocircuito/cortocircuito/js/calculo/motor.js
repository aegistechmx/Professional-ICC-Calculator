var Motor = (function() {
    ...
    function ejecutar() {
        ...
        for (var i = 0; i < puntos.length; i++) {
            ...
            var configValidacion = {
                ...
                fc: Fcc || 0.8,
                ft: f.tempAmbiente ? (f.tempAmbiente > 30 ? 0.91 : 1.0) : 0.91,
    ...
    function evaluarSistema(punto, nodo) {
        ...
        var nDispositivos = sistema.estado ? sistema.estado.nodos.filter(function(n) { return n.equip && n.equip.cap; }).length : 0;

/**
 * shared/utils/validator.js - Validación REAL para Enterprise
...
function validateSystemInput(data) {
  ...
  const required = [
    'I_carga', 'material', 'tempAislamiento', 'tempAmbiente',
    'nConductores', 'paralelos', 'tempTerminal', 'voltaje',
    'FP', 'longitud', 'tipoSistema'
  ];

...
exports.iccSchema = z.object({
    ...
    x0Config: z.enum(['plano_acero', 'plano_pvc', 'tripode_acero', 'tripode_pvc']).default('plano_acero'),
    tipoAterrizamiento: z.enum(['yg_solido', 'yg_resistivo', 'delta']).default('yg_solido'),
    zRetornoTierra: z.number().nonnegative().optional()
});

exports.fallaMinimaSchema = z.object({
    puntosMax: z.array(z.object({
        nombre: z.string(),
        R: z.number(),
        X: z.number(),
        Z: z.number(),

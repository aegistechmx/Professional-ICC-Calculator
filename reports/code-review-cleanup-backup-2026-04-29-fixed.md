...
| Controller | Issues Found | Security Risk | Performance | Recommendation |
|------------|--------------|---------------|-------------|----------------|
| simulation.controller.js | 4 | High | Poor | Rewrite |
| simulation.service.controller.js | 6 | High | Poor | Rewrite |
| proteccion.controller.js | 2 | Medium | Good | Refactor |
| powerflow.controller.js | 3 | High | Poor | Rewrite |
| contingency.controller.js | 3 | High | Poor | Rewrite |
| opf.controller.js | 3 | High | Poor | Rewrite |

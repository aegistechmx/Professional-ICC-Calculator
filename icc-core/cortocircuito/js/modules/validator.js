/**
 * modules/validator.js — Validador de Entrada [DEPRECATED]
 * 
 ...
 *    - ValidationEngine.runAll() para validación completa del sistema
 *    - SimulationContext.buildContext() para normalización de datos
 * 
 * 📚 Migración:
 *    - Validator.validarEntrada(ctx) → SimulationContext.buildContext(data)
 *    - Validator.validarNodo(nodo) → ValidationEngine.validateNode(nodo, systemCtx)
 * 
